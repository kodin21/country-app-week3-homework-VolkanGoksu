...
const CountryListCard = ({ name, flag, capital, language }) => {
  ...
  return (
    <>
      ...
      <figure onClick={toggleModal}  className="bg-white text-white h-60 rounded-lg shadow-md  cursor-pointer" >
        <img
          alt="user"
          ...
          <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
            <div class="md:flex items-center">
              <div class="rounded-full border border-gray-300 flex items-center justify-center w-16 h-16 flex-shrink-0 mx-auto">
                 <img className="rounded-full border border-gray-300 flex items-center justify-center w-16 h-16 flex-shrink-0 mx-auto" src={flag}/>
              
              </div>
              <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                <p class="font-bold"><span className="font-medium">Country Name: </span> {name}</p>
...
{/* <div>
<img alt="user" className="w-32 h-32  mx-auto mt-7" src={flag} />
<p className="text-gray-500">
  <span className="font-medium">Country: </span>
  {name}
</p>
...
// position: fixed top: 50% left: 50% border-solid bg-white overflow-auto rounded-lg  outline-none p-40